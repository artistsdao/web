...
import { FaTwitter, FaDiscord, FaReddit, FaShip, FaMedium, FaShoppingCart, FaInfinity } from 'react-icons/fa';
        ...
        <Container>
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2 ml-2 sm:ml-0">
              ...
              <a
                href={projectConfig.redditUrl}
                aria-label={`${projectConfig.nftName} on Reddit`}
                rel="noopener noreferrer"
                target="_blank"
                data-tip="Reddit"
                data-for="header"
              ...
              <a
                href={projectConfig.discordUrl}
                aria-label={`${projectConfig.nftName} on Medium`}
                rel="noopener noreferrer"
                target="_blank"
                data-tip="Medium"
                data-for="header"
              ...
              <a
                href={projectConfig.looksrareUrl}
                aria-label={`${projectConfig.nftName} on LooksRare`}
                rel="noopener noreferrer"
                target="_blank"
                data-tip="LooksRare"
                data-for="header"
